...
%{!?commit:
%global commit 23a6272933d7376cd348dd6b2ca86941af22a886
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_MAJOR=3 OS_GIT_MINOR=6+ OS_GIT_VERSION=v3.6.0-rc.0+23a6272-496 OS_GIT_TREE_STATE=clean OS_GIT_COMMIT=23a6272
}
